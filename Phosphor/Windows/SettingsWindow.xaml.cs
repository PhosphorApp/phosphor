...
public partial class SettingsWindow : JukeboxWindow
{
    ...
    public SettingsWindow(AppSettings settings)
    {
        ...
        CbShowMoveViewerButtons.IsChecked = settings.ShowMoveViewerButtons;
        ...
        SliderTrackIconSize.Value = settings.DmdTrackIconSizeModifier;
    ...
    private void ApplySettings()
    {
        ...
        _settings.ShowMoveViewerButtons = CbShowMoveViewerButtons.IsChecked == true;
        ...
        _settings.DmdTrackIconSizeModifier = Math.Clamp((int)SliderTrackIconSize.Value, -12, 24);
