...
public partial class BackglassWindow : JukeboxWindow
{
    ...
    public void AttachViewModel(JukeboxViewModel vm)
    {
        ...
        // JukeboxPlayer owns all six command handlers. Stop AND seek orchestration are fully relocated
        // into JukeboxPlayer; only the play body (OnPlayRequested) still lives in this window behind
        // IPlaybackHost.Play and relocates in a later increment.
